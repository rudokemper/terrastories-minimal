...
3. [Building Map Tiles](#build-the-map-tiles)

4. [Running the server](#make-it-go)

5. [Updating the tileserver map](#updating-the-tileserver-map)
...
available options and reasonable starting values. To view a map equipped with bookmarks
and other customizations, visit `localhost:3000/map/`.
